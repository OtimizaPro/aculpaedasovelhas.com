    ...
    <header>
        <nav>
            ...
            <ul>
                ...
                <li><a href="https://medium.com/@Anderson.Otimiza" target="_blank">Medium</a></li>
            </ul>
        </nav>
    </header>
        ...
        <article class="manifesto-content">
            ...
            <div class="entry-content">
                ...
                <ul>
                    ...
                    <li>Aqui há Sabedoria — Como Desvelar os enigmas Bíblicos</li>
                    <li>As Quatro Bestas de Daniel — Daniel 7</li>
                    ...
                    <li>As Sete Trombetas — Ap 8–11</li>
                    <li>As Duas Testemunhas — Ap 11:3–13</li>
                    <li>Jesus, um Anjo? - A Revelaçao (apocalipse)</li>
                ...
                <p>Pois esta Obra somente foi possível ser, mediante às Revelações que me foram entregues a meu pedido pedinte, a minha insistência insistente, perante pelo o que Espírito Santo enfim determinou, para que eu, anderson belem costa, as entendesse e as compartilhasse com meus irmãos e irmãs em todo o Mundo.</p>

                <p>Vivemos em uma Gloriosa época onde a comunicação, placa mãe das sociedades, em seu momento mais acessível e Uno, onde muitos falam para muitos, onde o Branco da Verdade Cavalgará Vitorioso e para Vencer sobre o Arco da Aliança ante a escuridão do engano, deste grande engano que vivenciamos.</p>

                <p>Este é o tempo em que podemos falar e muito e muitos a muitos povos, nações e línguas tão feroz e veloz quanto o Trovão que Vai de canto a canto do Mundo mais rápido que o Vento que Venta em cada um dos quatro cantos do Mundo.</p>

                <p>Nestes tempos em que Falar o Trovão, nenhuma outra informação será mais veiculada, compartilhada, lida, falada e ouvida do que a Palavra Viva, pois Viva sendo, Viveu para aqui estar.</p>
